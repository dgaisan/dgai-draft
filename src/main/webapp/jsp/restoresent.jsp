            ...
            <div class="package article_cloud">
                <div class="article">
                    <div class="article_title article_title_center">
                        The eMail with reset confirmation has been sent successfully!
                        <br />
                        <span>
                ...
                <div class="article_banner">
                	<form action="#">
                        ...
                        <div class="signing_text signing_text_second">
                        	The eMail with reset confirmation has been sent to <a href="#" title=""><s:property value="login" /></a>
                            <p>Note: If you have not recieved eMail with confirmation code, check your spam folder</p>
                        </div><!--end input_block-->
                    </form>
                </div>
            </div>
