...
<!--Recaptcha imports can be deleted?-->
                ...
                <div class="article_banner">
                	<s:form action="login" namespace="/">
                    	<div class="input_block">
                    		<input name="login" id="login" type="text" class="input" placeholder="eMail Address" />
                    	...
                    	<div class="input_block">
                            ...
                            <s:if test="fieldErrors.containsKey('password')">
	                            <div class="error">
	                            	...
	                            	<span class="error_top"></span>	
	                                <div class="error_center">
	                                	<label><s:fielderror fieldName="password" /></label>
	                                </div><!--end error_center-->
	                            	<span class="error_bottom"></span>	
	                            </div><!--end error-->
								<script type="text/javascript">
									//<![CDATA[
							            document.getElementById("password").className += " not_valid ";
							        //]]>
    							</script>
	                        </s:if>
                        </div><!--end input_block-->
                    	<div class="input_block">
                    		<a href="jsp/restorepassword.jsp" class="remember"> Forgot Password? </a>
                            <br />
                    		<s:a action="memberships" cssClass="remember"> Need Account? Click here to register </s:a>
                        </div><!--end input_block-->
                        ...
                        <input type="submit" class="button sign_in" />
                    </s:form>
                </div>
            </div>
        </article>
