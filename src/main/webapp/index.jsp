...
<head>
    ...
    <meta name="copyright" content="Copyright HTML5MAKER.com 2012. All Rights Reserved.">
    <meta name="og:title" content="HTML5 MAKER">
    ...
    <meta name="og:url" content="http://www.html5maker.com/">
    <meta name="og:image" content="">
    <meta name="DC.title" content="HTML5 MAKER">
    ...
    <link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family=Lato:300,400,400italic,700,900,900italic,700italic|Ubuntu:300,700&subset=latin,cyrillic-ext">
    <link rel="stylesheet" href="css/main.css">
    <title>
        HTML5 MAKER | Create HTML5 Banner, Slideshow or Presentation easily! It will work everywhere: Mac, PC, iPad, iPhone, Android and other platforms | Try it for FREE! | www.html5maker.com
    </title>
</head>
<body>
    <div class="wrapper">
        <header>
            <div class="repeatx header">
                <div class="package header_light header_430">
                    <div class="package header_rays header_430">
                        <div class="banner_container">
                            ...
                            <div class="package hint_easy">
                                It's Easy
                            </div>
                            <div class="package banner_right">
                            </div>
                            <div class="banner_left banner_left_40">
                                <div class="logo">
                                    <div class="logo_over">
                                        The Best Online Banner &amp; Slideshow Application Ever!
                                    </div>
                                    <div class="package logo_main">
                                        HTML5 Maker
                                    </div>
                                    <div class="logo_slogan">
                                        The Simplest Way to Create Awesome HTML5 Banners &amp; Slideshows for
                                        <span>
                                            FREE *
                                        </span>
                                    </div>
                                ...
                                <div class="features">
                                    <div class="package feature_first">
                                        Create interactive HTML5
                                        <span>
                                            Banner Ads
                                        </span>
                                        , attractive
                                    ...
                                    <div class="package feature_second">
                                        <span>
                                            Easy
                                        </span>
                                        to use App with
                                    ...
                                    <div class="package feature_third">
                                        <span>
                                            Download for FREE!
                                        </span>
                                        It'll work everywhere on Mac/PC &amp; iPhone/iPad or Android
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <article>
            <div class="package article_cloud">
                <div class="article">
                    <div class="package hint_examples">
                        Click here to see Examples.
                    </div>
                    <div class="article_btn">
                        <p>
                            <a href="design/create.html" class="package article_btn_start"
                    ...
                    <div class="article_title">
                        No restrictions. No plug-ins.
                        <a href="http://html5maker.com/examples" title="Click here to see Templates.">Look at Templates!</a>
                        <br />
                        <span>
                            The best results with minimum effort. No programming skills is required!
                        </span>
                    </div>
                    <div class="article_devices">
                        <div class="package article_devices_phone">
                            It works on Phones such as iPhone, Android, Blackberry, Windows Phone
                            and other.
                        </div>
                        <div class="package article_devices_laptop">
                            It works on Computers such as Mac, Windows PC or Linux.
                        </div>
                        <div class="package article_devices_tablet">
                            It works on Tablets such as iPad, Android, Blackberry, Windows 8, Windows
                            RT, Linux and other.
                        </div>
                        <div class="article_devices_title">
                            Equally Brilliant on Mac, PC, iPhone, iPad, Android &amp; other platforms!
                        </div>
                    </div>
                </div>
            </div>
