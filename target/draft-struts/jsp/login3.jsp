                ...
                <div class="article_banner">
                	<form action="">
                    	<div class="input_block">
                    		<input name="" type="text" class="input valid not_valid" placeholder="eMail Address">
                            <div class="error">
                    	...
                    	<div class="input_block">
                    		<input name="" type="text" class="input valid not_valid" placeholder="Password">
                            <div class="error">
                            	<span class="error_left"></span>
                            	<span class="error_top"></span>	
                                <div class="error_center">
                    	...
                    	<div class="input_block">
                        	<span class="niceCheck" onclick="changeCheck(this)" id="niceCheckbox1"><input name="" type="checkbox" value="" />Remember</span>
                            <a href="#" class="remember">Forgot Password ?</a>
                        </div><!--end input_block-->
                        <div class="capcha">
                        	<img src="img/capcha.png" alt="">
                        </div><!--end capcha-->
                        <input name="" type="button" class="button sign_in">
                    </form>
                </div>
            </div>
        </article>
